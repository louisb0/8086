...
const std::vector<Encoding> instruction_encodings = {
    ...
    {"add",    MASK(0xFC), EQUALS(0b10000000), NONE,    S(0x02), W(0x01), MOD(0xC0), REG(0x38), RM(0x07), Encoding::IMM_TO_RM},
    ...
    {"sub",    MASK(0xFC), EQUALS(0b10000000), NONE,    S(0x02), W(0x01), MOD(0xC0), REG(0x38), RM(0x07), Encoding::IMM_TO_RM},
    ...
    {"cmp",    MASK(0xFC), EQUALS(0b10000000), NONE,    S(0x02), W(0x01), MOD(0xC0), REG(0x38), RM(0x07), Encoding::IMM_TO_RM},
